$(document).ready(function() {
  const apiRoot = 'https://tasks-prod-kodilla-tasks-ga5c2x.mo2.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://tasks-prod-kodilla-tasks-ga5c2x.mo2.mogenius.io/v1/trello';
